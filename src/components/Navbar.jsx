    ...
    <div className="">
      <div className="px-10 py-5">
        <main className="flex justify-between  px-3 shadow-md bg-black/80 py-3 rounded-xl items-center">
          ...
          <div className="md:flex gap-8 text-white font-semibold hidden">
            <Link href={"/"}>Home</Link>
            <Link href={"/about"}>About Us</Link>
            <Link href={"/contact"}>Contact</Link>
          </div>
          <div className="md:flex gap-2 bg-white px-2 py-2 rounded-xl hidden">
            <input
              type="text"
              name=""
              id=""
            ...
            <button onClick={handleClear} className="rounded-xl bg-cyan-400 text-white px-3 py-1">
              Clear
            </button>
          </div>
        </main>
